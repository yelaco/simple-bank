...
// Source: github.com/yelaco/simple-bank/db/sqlc (interfaces: Store)
//
...
func (m *MockStore) VerifyEmailTx(ctx context.Context, arg db.VerifyEmailTxParams) (db.VerifyEmailTxResults, error) {
	m.ctrl.T.Helper()
